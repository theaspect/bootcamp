...
| STM32 ![stm](http://store.mkprog.ru/wp-content/uploads/2017/11/STM32F103C8T6-ARM-STM32-Arduin0.jpg) | | | ![stm32](https://hallroad.org/wp-content/uploads/2018/03/STM32F103C8T6-ARM-STM32-Cortex-M3-Minimum-System-Development-Board-In-Pakistan-3.png) | Более низкоуровневый контроллер, поддерживающий USB-HID и CAN. Огромное количество вариаций. Использует собственный тулкит [STMCube](https://www.st.com/en/development-tools/stm32cubemx.html) и библиотеку [HAL](https://www.st.com/content/ccc/resource/technical/document/user_manual/2f/71/ba/b8/75/54/47/cf/DM00105879.pdf/files/DM00105879.pdf/jcr:content/translations/en.DM00105879.pdf) а также [FreeRTOS](https://ru.wikipedia.org/wiki/FreeRTOS) |
...
## JTAG [Joint Test Action Group](https://en.wikipedia.org/wiki/JTAG)

Аппаратный интерфейс предназначен для подключения сложных цифровых микросхем или устройств уровня печатной платы к стандартной аппаратуре тестирования и отладки.
...
режим обмена данными между устройствами компьютера или же между устройством и основной памятью, в котором центральный процессор (ЦП) не участвует. Так как данные не пересылаются в ЦП и обратно, скорость передачи увеличивается. Например, получать изображение по SPI и сразу выводить его на дисплей. Процессор при этом останется разгруженным
...
cтандарт промышленной сети, ориентированный, прежде всего, на объединение в единую сеть различных исполнительных устройств и датчиков. Режим передачи — последовательный, широковещательный, пакетный. настоящее время широко распространён в промышленной автоматизации, технологиях «умного дома», автомобильной промышленности и многих других областях. Стандарт для автомобильной автоматики. В ардуинах нет встроенной поддержки, работает через [шилд](http://amperka.ru/product/can-bus-shield) или контроллер MCP2515 (см. ниже)
...
## I2S
[Inter-IC Sound](https://ru.wikipedia.org/wiki/I%C2%B2S) стандарт для подключения аудио-устройств. Не путать с I2C. [Пример использования](https://eax.me/stm32-i2s/)
...
## PID, [proportional–integral–derivative controller](https://en.wikipedia.org/wiki/PID_controller)
Пропорционально-интегрально-дифференцирующий регулятор в устройствах с обратной связью, чтобы управлять переходными процессами. ПИД-регулятор формирует управляющий сигнал, являющийся суммой трёх слагаемых, первое из которых пропорционально разности входного сигнала и сигнала обратной связи (сигнал рассогласования), второе — интеграл сигнала рассогласования, третье — производная сигнала рассогласования. [Библиотека для Arduino](http://playground.arduino.cc/Code/PIDLibrary), [Подробное описание алгоритма](http://brettbeauregard.com/blog/2011/04/improving-the-beginners-pid-introduction/). Реализация на [питоне](https://github.com/ivmech/ivPID) для использования в Omega2

## PLC, [programmable logic controller](https://ru.wikipedia.org/wiki/%D0%9F%D1%80%D0%BE%D0%B3%D1%80%D0%B0%D0%BC%D0%BC%D0%B8%D1%80%D1%83%D0%B5%D0%BC%D1%8B%D0%B9_%D0%BB%D0%BE%D0%B3%D0%B8%D1%87%D0%B5%D1%81%D0%BA%D0%B8%D0%B9_%D0%BA%D0%BE%D0%BD%D1%82%D1%80%D0%BE%D0%BB%D0%BB%D0%B5%D1%80)
...
## ADC/DAC [Analog-to-Digital](https://ru.wikipedia.org/wiki/%D0%90%D0%BD%D0%B0%D0%BB%D0%BE%D0%B3%D0%BE-%D1%86%D0%B8%D1%84%D1%80%D0%BE%D0%B2%D0%BE%D0%B9_%D0%BF%D1%80%D0%B5%D0%BE%D0%B1%D1%80%D0%B0%D0%B7%D0%BE%D0%B2%D0%B0%D1%82%D0%B5%D0%BB%D1%8C)/[Digital-to-Analog Converter](https://ru.wikipedia.org/wiki/%D0%A6%D0%B8%D1%84%D1%80%D0%BE-%D0%B0%D0%BD%D0%B0%D0%BB%D0%BE%D0%B3%D0%BE%D0%B2%D1%8B%D0%B9_%D0%BF%D1%80%D0%B5%D0%BE%D0%B1%D1%80%D0%B0%D0%B7%D0%BE%D0%B2%D0%B0%D1%82%D0%B5%D0%BB%D1%8C)

## Jitter [фазовое дрожание цифрового сигнала данных](https://ru.wikipedia.org/wiki/%D0%94%D0%B6%D0%B8%D1%82%D1%82%D0%B5%D1%80)
...
[Пример работы с FPGA](https://eax.me/icestick/)

## Фильтры
<img src="https://eax.me/files/2018/09/basic-filter-charts.jpg" width=200 />
<img src="https://eax.me/files/2018/09/basic-filter-schematic.jpg" width=200 />

[Разбор различных фильтров](https://eax.me/basic-filters/)

## Петля Гистерезиса

[График](https://ru.wikipedia.org/wiki/%D0%93%D0%B8%D1%81%D1%82%D0%B5%D1%80%D0%B5%D0%B7%D0%B8%D1%81#%D0%92_%D1%8D%D0%BB%D0%B5%D0%BA%D1%82%D1%80%D0%BE%D0%BD%D0%B8%D0%BA%D0%B5_%D0%B8_%D1%8D%D0%BB%D0%B5%D0%BA%D1%82%D1%80%D0%BE%D1%82%D0%B5%D1%85%D0%BD%D0%B8%D0%BA%D0%B5) описывающий циклический переход между различными состояниями системы. Используется наряду с PID-контроллерами.

<img src="https://upload.wikimedia.org/wikipedia/commons/thumb/a/aa/Hysteresis_sharp_curve.svg/440px-Hysteresis_sharp_curve.svg.png" width=200 />
...
<img src="https://ae01.alicdn.com/kf/HTB1x1BHKrSYBuNjSspfq6AZCpXas/CJMCU-CP2102-MICRO-USB-UART-ttl-6Pin.jpg_640x640.jpg" width=200 /> Компактная [версия](https://ru.aliexpress.com/item/CJMCU-CP2102-MICRO-USB-to-UART-TTL-Module-6Pin-Serial-Converter-UART-STC-Replace-FT232-NEW/32750167241.html)
...
## AD9280 АЦП
8 bit, 32 Msps [Даташит](http://docs-europe.electrocomponents.com/webdocs/0780/0900766b8078003c.pdf)

## AD9708 ЦАП
8 bit, 100 Msps [Даташит](http://docs-europe.electrocomponents.com/webdocs/077f/0900766b8077ff95.pdf)

## MCP2515 [Stand-Alone CAN Controller With SPI™ Interface](http://files.amperka.ru/datasheets/MCP2515.pdf)

Контролллер для CAN шины. [Либа](https://github.com/coryjfowler/MCP_CAN_lib)
...
## Hirose U.FL
[Коннектор](https://en.wikipedia.org/wiki/Hirose_U.FL) применяется для подключения миниатюрных высокочастотных антенн до 6 GHz. Применяется в поверхностном монтаже. Не предназначен для частого использования: до 30 подключений.
