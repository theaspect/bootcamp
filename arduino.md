...
Используется для фильтрации переменного тока. Подробная [статья](http://easyelectronics.ru/kondensator-i-rc-cepochka.html).
...
В схемотехнике третье состояние в дополнение к логическому 0 и 1 – высокоимпедансное. Не путать с тернарной логикой. Позволяет убирать весь выход с элемента, чтобы защитить общую шину. [wiki](https://en.wikipedia.org/wiki/Three-state_logic)
