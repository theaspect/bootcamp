# bootcamp
Цель документа: данный список должен упростить вхождение разработчика в область веб-разработки. Исходники на [GitHub](https://github.com/theaspect/bootcamp)
...
4. Java Concurrency in Practice. Brian Goetz (Перевода нет 4/5)
5. Java. Библиотека профессионала. Том 1. Основы. Кей Хорстманн, Гари Корнелл (9-е издание по java 7 ?/5)
6. Java. Библиотека профессионала. Том 2. Расширенные средства. Кей Хорстманн, Гари Корнелл (9-е издание по java 7 ?/5)
7. Java 8. Полное руководство. Герберт Шилдт (9-е издание 5/5)
8. Java. Эффективное программирование. Джошуа Блох (5/5)
9. Java Concurrency in Practice. Brian Goetz (перевода нет, 5/5)
